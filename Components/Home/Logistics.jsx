...
import accordionImage2 from '../../assets/NewImages/index/image/delivered.jpg'
...
const Logistics = () => {
    ...
    return (
        <YellowBack>
            ...
            <div className={`flex gap-y-9 text-white relative overflow-hidden flex-col bg-yellow ${styles.accordion}`}>
